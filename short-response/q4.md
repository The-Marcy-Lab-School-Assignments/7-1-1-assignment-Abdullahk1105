...
The data type of `phoneId` would be a string. The useParams hook returns a key value pair. In our case use params would return {phoneId : '5'}.

# Feedback

3/3 points
Yes, the phoneId would be a string
